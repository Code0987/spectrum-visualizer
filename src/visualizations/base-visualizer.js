...
class BaseVisualizer {
  constructor(canvas, audioProcessor) {
    ...
    this.colorSchemes = {
      ...
      rainbow: {
        ...
        secondary: '#00ff00',
        tertiary: '#0000ff',
        gradient: ['#ff0000', '#ff7f00', '#ffff00', '#00ff00', '#0000ff', '#9400d3']
      }
    };
  ...
  getSpectrumColor(position) {
    ...
    return this.interpolateColor(colors[lowerIndex], colors[upperIndex], factor);
  }
  ...
  getProcessedData(barCount = null) {
    ...
    for (let i = 0; i < count; i++) {
      ...
      processedData[i] = (sum / samplesPerBar) * this.settings.sensitivity;
    }
